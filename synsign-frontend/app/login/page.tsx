...
import { User, Lock, Eye, ShieldCheck, HandMetal } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatusMsg("Login failed. Verify credentials.");
    }
  };
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-center justify-between gap-16 my-auto max-w-7xl mx-auto w-full py-12">
        ...
        <div className="w-full lg:w-[55%] flex flex-col justify-center">
          ...
          <p className="text-lg lg:text-xl text-slate-600 leading-relaxed max-w-xl">
            SynSign connects communication between everyone using intelligent AI and the beauty of Indian Sign Language.
          </p>
        </div>
        ...
        <div className="w-full lg:w-[440px] bg-white rounded-3xl p-8 lg:p-10 shadow-[0_10px_40px_rgb(0,0,0,0.05)] border border-slate-200/80 relative">
          ...
          <div className="text-center mb-7">
            <h2 className="text-2xl font-serif font-bold text-slate-900 mb-1">Welcome back!</h2>
            <p className="text-xs text-slate-500">Sign in to continue to SynSign</p>
          </div>

          {statusMsg && (
            <div className="mb-4 text-center text-xs font-medium p-2 rounded bg-red-100 text-red-700">
              {statusMsg}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1.5">
                <a href="#" className="text-xs font-medium text-slate-500 hover:text-slate-800">Forgot Password?</a>
              </div>
            </div>
          ...
          <div className="mt-6 text-center text-xs text-slate-500">
            Don't have an account? <a href="/signup" className="font-medium text-[#1b4332] hover:underline">Sign up</a>
          </div>
